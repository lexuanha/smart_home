              ...
              if ($res_id->num_rows == 0){
                ...
                if ($res_type->num_rows > 0){
                  while($row = $res_type->fetch_assoc()){
                    ...
                    $cur_id = $row["code"];
                    $sensor = $row["type"];
                    $min_range = explode(",",$row["range"])[0];
                    $max_range = explode(",",$row["range"])[1];
                    $don_vi = $row["ext"];
                    $color = $row["des"];
                            ...
                            echo "<script>
                              function printData(){
                                  ...
                                  setInterval(function(){
                                    ...
                                    drawDonut(a$cur_id.getContext(\"2d\"),60,90,".$row["value"] .",befor$cur_id,0,$max_range," .$ind .");
                              ...
                              <div style=\"margin:10px 10px 10px 10px;border: 1px solid gray; width: 395px ; height : 200px ;float:left ;background-color: #ECF0F5;\">
                                <div class=\"sub-title\">
                                  <span style=\"margin-left: 15px; font-size: 20px; color:#7FFF00;\"> $sensor</span>
                                </div>
                                ...
                                <div style=\"float:left;\">
                                  <table title=\"$cur_id Table\" style=\" margin:20px 0px 10px 0px ; border-collapse: collapse;\">
                                    ...
                                    <tr>
                                      ...
                                      <td style=\"border: none;font-size: 15px;\"></td>
                                      <td  solspan=\"2\" style=\"border: none;font-size: 15px;color:green;\"> Good </td>
                                    </tr>
                                  </table>
                                </div>
                              </div>
